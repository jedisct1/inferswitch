...
def print_comparison(evaluations: List[Dict]):
    ...
    print("=" * 90)
    print(f"{'Approach':<25} {'MAE':>8} {'RMSE':>8} {'Accuracy':>12} {'Avg Time':>12} {'Speedup':>10}")
    print("-" * 90)
    ...
    for eval in evaluations:
        ...
        print(f"{eval['name']:<25} {eval['mae']:>8.3f} {eval['rmse']:>8.3f} "
...
def main():
    ...
    evaluations.append(evaluate_classifier(original, questions, "Original (Thinking Mode)"))
    evaluations.append(evaluate_classifier(optimized, questions, "Optimized (Non-Thinking)"))
