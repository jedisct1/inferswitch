...
def main():
    ...
    if len(all_results) >= 2:
        ...
        for result in all_results:
            ...
            print(f"{model_name:<50} {metrics['mae']:>8.3f} {metrics['rmse']:>8.3f} "
        ...
        if len(all_results) >= 2:
            ...
            acc_improvement = new_metrics['bucket_accuracy'] - old_metrics['bucket_accuracy']
            time_increase = (new_metrics['avg_time_ms'] - old_metrics['avg_time_ms']) / old_metrics['avg_time_ms'] * 100
