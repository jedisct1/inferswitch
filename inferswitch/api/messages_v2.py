    ...
    if cached_response is not None:
        ...
        if request.stream:
            ...
            async def stream_cached_response():
                async for chunk in generate_sse_from_cached_response(cached_response, None):
                    yield chunk
...
async def generate_sse_from_cached_response(cached_response: dict, router_text: str = None):
