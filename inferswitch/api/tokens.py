...
async def count_tokens(
    ...
    if not oauth_token and not x_api_key:
        raise HTTPException(status_code=401, detail="Missing x-api-key header or OAuth token")
    ...
    if PROXY_MODE:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail="Error connecting to Anthropic API")
