...
class BackendConfigManager:
                ...
                with open(config_file) as f:
                    ...
                    for name, file_backend_config in file_configs.items():
                        if name in configs:
                            ...
                            configs[name] = BackendConfigManager._merge_configs(configs[name], file_backend_config)
                        else:
    ...
    def _get_default_configs() -> Dict[str, BackendConfig]:
        ...
        return {
            ...
            "lm-studio": BackendConfig(
                ...
                api_key=os.environ.get("LM_STUDIO_API_KEY", "lm-studio"),  # LM-Studio doesn't require real API key
    ...
    @staticmethod
    def _merge_configs(base_config: BackendConfig, override_config: BackendConfig) -> BackendConfig:
    ...
    def should_force_difficulty_routing() -> bool:
        ...
        if os.environ.get("INFERSWITCH_FORCE_DIFFICULTY_ROUTING"):
            return os.environ["INFERSWITCH_FORCE_DIFFICULTY_ROUTING"].lower() in ["true", "1", "yes", "on"]
