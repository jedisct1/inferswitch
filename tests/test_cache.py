...
def test_cache_with_environment_details():
    ...
    request_data["messages"][0]["content"][1]["text"] = "<environment_details>\n# Current Time\n6/20/2025, 4:43:32 PM\n</environment_details>"
    ...
    assert response1_data == response2_data, "Cache should return same response for different timestamps"
...
def test_cache_disabled():
    ...
    request_data = {
        "model": "claude-3-opus-20240229",
        "messages": [
            {"role": "user", "content": "Cache disabled test"}
        ],
        "max_tokens": 100
    }
