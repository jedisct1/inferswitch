...
def test_both_approaches():
    ...
    print("=" * 80)
    print(f"{'Question':<50} {'Exp':>4} {'Orig':>6} {'Direct':>8} {'O.Time':>8} {'D.Time':>8}")
    print("=" * 80)
    ...
    for q in test_questions:
        ...
        print(f"{question:<50} {expected:>4} {orig_pred:>6.1f} {direct_pred:>8.1f} {orig_time:>7.0f}ms {dir_time:>7.0f}ms")
