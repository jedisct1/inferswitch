    ...
    test_cases = [
        ...
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Analyze this screenshot and describe what's happening",
                }
            ],
            "expected": "vision",
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Create a matplotlib chart showing sales data",
                }
            ],
            "expected": "vision",
        },
        ...
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Help me debug this JavaScript error: TypeError",
                }
            ],
            "expected": "coding",
        },
        ...
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Implement a binary search algorithm in C++",
                }
            ],
            "expected": "coding",
        },
        ...
        {
            "messages": [
                {"role": "user", "content": "Calculate the derivative of x^2 + 3x + 1"}
            ],
            "expected": "math",
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Solve this linear regression problem with statistical analysis",
                }
            ],
            "expected": "math",
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "What's the probability of getting heads twice in three coin flips?",
                }
            ],
            "expected": "math",
        },
        ...
        },
        {
            "messages": [
                {
                    "role": "user",
                    "content": "What are the advantages and disadvantages of renewable energy?",
                }
            ],
            "expected": "general",
        },
        ...
        # Multimodal tasks
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Create a Python script to analyze this image data and generate a statistical chart",
                }
            ],
            "expected": "multimodal",
        },
...
def test_expertise_routing():
    ...
    try:
        ...
        backends = {
            "openai": MockBackend(
                BackendConfig(
                    name="openai", base_url="https://api.openai.com", api_key="test"
                ),
        ...
        for expertise_area, expected_backend in test_cases:
            try:
                backend = router.select_backend(
                    model="test-model", expertise_area=expertise_area
                )
                ...
                if backend.name == expected_backend:
                    ...
                    print(
                        f"✗ Expertise {expertise_area}: Expected {expected_backend}, got {backend.name}"
                    )
                    failed += 1
    ...
    test_cases = [
        {
            "messages": [
                {
                    "role": "user",
                    "content": "Create a Python script to analyze image data and plot statistical charts",
                }
            ],
