...
def test_difficulty_rating():
    ...
    test_queries = [
        ...
        {"query": "Write a Python function to calculate factorial", "expected": "medium"},
        {"query": "Implement a distributed cache with consistent hashing", "expected": "hard"},
        {"query": "Debug this React component that has a memory leak", "expected": "hard"}
    ]
